...
SECRET_KEY = '7-7q_aox*wp3!-+f!5lx1xhda825lsqj^*1u22-f5agqrmvywl'
...
EMAIL_PORT = '587'
EMAIL_HOST_USER = 'website@geekshop.local'
...
SOCIAL_SECRETS_FILE = 'geekshop/client_secret_google+.json'

SOCIAL = {}
if os.path.exists(SOCIAL_SECRETS_FILE):
    with open(SOCIAL_SECRETS_FILE, 'r') as f:
        SOCIAL = json.load(f)
        SOCIAL = SOCIAL.get('web')
